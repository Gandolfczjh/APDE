...
#     do
#         python ./test.py --advdataset_path $detector_i
#         echo "Finished python ./test.py --advdataset_path $detector_i..."
#         sleep 2
#     done
# done
...
#     do
#         python ./test.py --advdataset_path $attack_path$prepath
#         echo "Finished python ./test.py --advdataset_path $attack_path$prepath..."
#         sleep 2
#     done
# done
...
#             do
#                 temp2=$temp1$angle_i
#                 python ./test.py --advdataset_path $temp2
#                 echo "Finished python ./test.py --advdataset_path $temp2..."
#                 sleep 0.1
#             done
#         done
#     done
...
do 
    ...
    do
        ...
        python ./test.py --advdataset_path $temp
        echo "Finished python ./test.py --advdataset_path $temp..."
        sleep 0.1
    done
done